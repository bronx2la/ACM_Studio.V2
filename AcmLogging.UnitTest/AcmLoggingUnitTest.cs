...
namespace AcmLogging.UnitTest
{
    ...
    public class AcmLoggingUnitTest
    {
        ...
        [Fact]
        public void PerformanceLoggingTest()
        {
            var fd = GetAcmLoggingDetail("Starting Performance Unit Test", null);
            AcmLogger.WriteDiagnostic(fd);
            
            var tracker = new PerformanceTracker("PerformanceTracker_UnitTest", "NoUserId", fd.UserName, fd.Location, fd.Product, fd.Layer);
        ...
        [Fact]
        public void StoredProcErrorTest()
        {
