...
if (object_id('dbo.prc_GenevaSma_Transform') is not null)
    drop procedure dbo.prc_GenevaSma_Transform
go

create procedure dbo.prc_GenevaSma_Transform
  @ReportEndDate date
  as 
  
  delete from tbl_GenevaSma where ReportEndDate3 = @ReportEndDate
  
  insert into dbo.tbl_GenevaSma
      select
        Textbox1,
        Textbox3,
        Textbox5,
        ...
        RM3,
        Sponsor
      from dbo.tbl_GenevaSma_Staging
